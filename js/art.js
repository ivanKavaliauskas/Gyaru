...
// Chica Samurái Gyaru
const gyaruPixelArt = [
    '....YYYYYYYY....', '...YYYYYYYYYY...', '..YYYTTTTTTYYY..', '..YYTTWTTWTTYY..',
    '..YTTTBBTTBBTTY.', '..YTTTTTTTTTTTY.', '...TTTPPPPPPPT..', '....PPPPPPPPP...',
    '....PPPPPPPPP...', '...PPPPPPPPPPP..', '...PPYPPPPPYPP..', '...YYYY...YYYY..',
    '..YYYY.....YYYY.', '..YY.........YY.', '..TT.........TT.', '..BB.........BB.'
];

// Enemigo Monótono Común (Estilo Snow Bros)
const enemyPixelArt = [
    '....GGGGGGGG....', '...GGGGGGGGGG...', '..GGWGGGGGGWGG..', '..GWBBGGGGBBWG..',
    '..GGGGGGGGGGGG..', '..GGGGGGGGGGGG..', '...GGGGGGGGGG...', '....GGGGGGGG...',
    '..GGGGGGGGGGGG..', '.GGGGGGGGGGGGGG.', '.GGGGGGGGGGGGGG.', '.GG..GGGGGG..GG.',
    '.....GGGGGG.....', '....GG....GG....', '....GG....GG....', '...GGG....GGG...'
];

// Item de Recompensa: Té de Boba (Bubble Tea)
const bobaPixelArt = [
    '....WWWWWW......', '....W....W......', '...PPPPPPPP.....', '...P......P.....',
    '...P......P.....', '...P.B..B.P.....', '...P......P.....', '...P.B..B.P.....',
    '...P......P.....', '...PPPPPPPP.....', '....PPPPPP......', '................'
];
...
// ==========================================
const colorMapGyaru = { '.': null, 'Y': '#f1c40f', 'T': '#e0a96d', 'W': '#ffffff', 'B': '#000000', 'P': '#ff007f' };
...
function crearTexturaPixelArt(scene, key, matrix, colorMap, width, height, scale) {
    if (!scene || !scene.textures) return;
    let canvasTexture = scene.textures.createCanvas(key, width * scale, height * scale);
...
function cargarTexturasExtra(scene) {
    ...
    if (!scene.textures.exists('boss_critic')) {
        crearTexturaPixelArt(scene, 'boss_critic', bossPixelArt, colorMapEnemy, 16, 16, 8);
    }
    if (!scene.textures.exists('boredom_shot')) {
        let shot = scene.make.graphics({ x: 0, y: 0, add: false }).fillStyle(0x7f8c8d, 1).fillCircle(12, 12, 12);
...
function cargarTexturaFruta(scene) {
    ...
    if (!scene.textures.exists('cherry_fruit')) {
        crearTexturaPixelArt(scene, 'cherry_fruit', cerezaPixelArt, colorMapCereza, 12, 12, 2.5);
    }
}
